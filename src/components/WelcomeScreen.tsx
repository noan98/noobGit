/*
 * WelcomeScreen — リポジトリを開いていないタブの画面（新しいタブページ）。
 *
 * #263 のタブ化により、この画面は「タブの中でまだリポジトリを開いていない状態」
 * を表す。前回セッションのタブは起動時に自動で開かれる（App.tsx / RepoWorkspace の
 * #262）ため、この画面が出るのは「初回起動」「新しいタブを開いたとき」「自動
 * オープンに失敗したとき」「ツールバーの『別のリポジトリ』で戻ってきたとき」。
 *
